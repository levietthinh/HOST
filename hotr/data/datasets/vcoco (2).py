...
def build(image_set, args):
    ...
    PATHS = {
        "train": (root / "data/images/train/", root / "data/vcoco" / 'vcoco_trainval.json'),
        "val": (root / "data/images/test", root / "data/vcoco" / 'vcoco_test.json'),
        "test": (root / "data/images/test", root / "data/vcoco" / 'vcoco_test.json'),
    }
