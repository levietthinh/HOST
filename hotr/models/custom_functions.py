...
from torch._torch_docs import tf32_notes
...
def _scaled_dot_product_attention(
    ...
    dropout_p: float = 0.0,
    relative_geometry_weights: Optional[Tensor] = None
) -> Tuple[Tensor, Tensor]:
    r"""
...
def multi_head_attention_forward(
    ...
    #
    attn_output, attn_output_weights = _scaled_dot_product_attention(q, k, v, attn_mask, dropout_p, relative_geometry_weights=relative_geometry_weights)
